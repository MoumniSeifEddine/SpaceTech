...
//$id=$_GET['id'];
//$prod=$functions->getProcutById($id);
?>
<style>
...
<div class="container">
    <!--<div class="row"><?php echo $prod[0]['nom_p']?></div>-->
    <div class="row">
        <div class="col"></div>
        <div class="col"></div>
    </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="thumbnail">
                <img src="image/image1.png" alt="" class="img-responsive">
                <div class="caption">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 product_img">
                        <img src="image/image1.png" class="img-responsive">
                    </div>
